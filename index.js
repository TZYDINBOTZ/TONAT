	...
	try {
		...
		if (anu.action == 'add') {
			...
			try {
				...
				sendButImage(anu.jid, teks, `Tobil bot`, img,but = [{buttonId:`apaaja`, 
			...
			try {
				...
				sendButImage(anu.jid, teks, `Tobil bot`, img,but = [{buttonId: `Hello World!`, buttonText: {displayText: `AMIN`}, type: 1}], options = {contextInfo: {mentionedJid: [num, htod]}})
